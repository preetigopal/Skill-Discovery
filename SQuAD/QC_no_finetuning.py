    ...
    def predict(self,context,batch_size):
        ...
        for algo in self.algo_list:
            ...
            if algo=='EpsilonGreedy':
                ...
                toss_indices = (toss <= self.explore_prob) 
...
def run_skill_discovery(eval_examples,new_ideal_policy1,new_ideal_policy2,y,banditModel,batch_size,num_algos):
    ...
    new_context = run_mysquad.getFineTunedContext(first_batch_flag,bert_model,
...
#     run_mysquad.fineTune(first_batch_flag,bert_model,output_dir,
...
#         run_mysquad.fineTune(first_batch_flag, bert_model, old_output_dir,
#                             output_dir, cached_train_examples_file)
...
for seed_num,seed in tqdm(enumerate(lst_seeds)):
    ...
    numQueries = 20000
    dim_context = 768;
    ideal_policy = np.load('outputs/labels_of_squad_question_category_train_data.npy')
